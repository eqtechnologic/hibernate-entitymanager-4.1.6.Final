...
public interface ExpressionImplementor<T> extends SelectionImplementor<T>, Expression<T>, Renderable {
	/**
	 * See {@link jakarta.persistence.criteria.CriteriaBuilder#toLong}
	 *
	...
	/**
	 * See {@link jakarta.persistence.criteria.CriteriaBuilder#toInteger}
	 *
	...
	/**
	 * See {@link jakarta.persistence.criteria.CriteriaBuilder#toFloat}
	 *
	...
	/**
	 * See {@link jakarta.persistence.criteria.CriteriaBuilder#toDouble}
	 *
	...
	/**
	 * See {@link jakarta.persistence.criteria.CriteriaBuilder#toBigDecimal}
	 *
	...
	/**
	 * See {@link jakarta.persistence.criteria.CriteriaBuilder#toBigInteger}
	 *
	...
	/**
	 * See {@link jakarta.persistence.criteria.CriteriaBuilder#toString}
	 *
