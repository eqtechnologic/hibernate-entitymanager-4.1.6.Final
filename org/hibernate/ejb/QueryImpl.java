...
public class QueryImpl<X> extends org.hibernate.ejb.AbstractQueryImpl<X> implements TypedQuery<X>, HibernateQuery {
	...
	private jakarta.persistence.LockModeType jpaLockMode = jakarta.persistence.LockModeType.NONE;

	@Override
    @SuppressWarnings({ "unchecked" })
	public TypedQuery<X> setLockMode(jakarta.persistence.LockModeType lockModeType) {
