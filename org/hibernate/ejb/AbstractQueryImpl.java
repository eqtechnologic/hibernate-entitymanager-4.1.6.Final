...
/**
 * Intended as a base class providing convenience in implementing both {@link jakarta.persistence.Query} and
...
public abstract class AbstractQueryImpl<X> implements TypedQuery<X> {
	...
	@Override
	public abstract TypedQuery<X> setLockMode(jakarta.persistence.LockModeType lockModeType);

	@Override
	public abstract jakarta.persistence.LockModeType getLockMode();
